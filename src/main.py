from agents.train import train_dqn
from agents.dqn import DQN
import argparse
from game_env.FlappyBirdLogicEnv import FlappyBirdLogicEnv
from game_env.FlappyBirdPygameEnv import FlappyBirdPygameEnv
import os
import pygame
...
env = FlappyBirdPygameEnv()

if args.train:
    trained_agent = train_dqn(env, num_episodes=args.episodes, filename=file)
